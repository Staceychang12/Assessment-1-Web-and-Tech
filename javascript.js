...
// =======================================
function initializeFlatland() {
  const square = document.getElementById('square');
  const words = document.getElementById('words');
  
  // Only run on the flatland page
  if (!square || !words) return;
  ...
  square.addEventListener('click', function() {
    // Generate and display a random buzzword phrase
...
// Generate a random buzzword-filled business phrase
...
// Initialize all interactive features after the DOM content has loaded
document.addEventListener('DOMContentLoaded', function() {
  initializeFlatland(); // Initialize Flatland functionality
});
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Initialize Flatland functionality
  initializeFlatland();
